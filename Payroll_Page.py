...
from OOP_Class import design_gui_interface # Importing design_gui_interface class from OOP_Class module
from OOP_Calculations import EmployeePayroll # Importing EmployeePayroll class from OOP_Calculations module
...
# ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
    ...
    background_image = Image.open("C:\\Users\\Admin\\PycharmProjects\\OOP Project\\PHOTOS\\BACKGROUND\\Portal2_Background.png")
...
# ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
    ...
    employee_image = my_gui_design.image1_design(frame, 61, 61, "C:\\Users\\Admin\\PycharmProjects\\OOP Project\\PHOTOS\\Profile_Picture.png", 140, 140)
...
# ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
    ...
    images = {}
    images['employee_image'] = ImageTk.PhotoImage(Image.open("C:\\Users\\Admin\\PycharmProjects\\OOP Project\\PHOTOS\\Profile_Picture.png").resize((295, 295)))
...
# ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
    ...
    def switch_to_profile_page(): # For Profile Button
        ...
        import Profile_Page
        Profile_Page.main(username)
    def switch_to_payroll_page(): # For Payroll Button
        window.destroy()  # Close current window
        import Payroll_Page
        Payroll_Page.main(username)
    def switch_to_account_page(): # For Account Button
        window.destroy()  # Close current window
        import Account_Page
        Account_Page.main(username)
    def switch_to_employee_portal(): # For Logo Button
        window.destroy()  # Close current window
        import Employee_Portal
        Employee_Portal.main(username)
    def log_out(): # For LogOut Button
        window.destroy()
        import Log_In_Page
    # Buttons
    profile_image = ImageTk.PhotoImage(Image.open("C:\\Users\\Admin\\PycharmProjects\\OOP Project\\PHOTOS\\LOGO\\Profile_Logo.png").resize((46, 51)))
    ...
    payroll_image = ImageTk.PhotoImage(Image.open("C:\\Users\\Admin\\PycharmProjects\\OOP Project\\PHOTOS\\LOGO\\Payroll_Logo.png").resize((51, 51)))
    ...
    account_image = ImageTk.PhotoImage(Image.open("C:\\Users\\Admin\\PycharmProjects\\OOP Project\\PHOTOS\\LOGO\\Account_Logo.png").resize((53, 51)))
    ...
    logo_image = ImageTk.PhotoImage(Image.open("C:\\Users\\Admin\\PycharmProjects\\OOP Project\\PHOTOS\\LOGO\\UNIS_Logo.png").resize((199, 92)))
    logo_button = my_gui_design.button_design(frame, 2, 822, 259, 125, "#5AACDB", "white", "", ("Century Gothic", 12, 'bold'))
    logo_button.config(image=logo_image, compound=tk.LEFT, relief=tk.FLAT, activebackground="#5AACDB", command=switch_to_employee_portal)
    UNIS_corporation_label = my_gui_design.label_design(frame, 61, 922, "UNIS Corporation", "#5AACDB", "white", ("Century Gothic", 11, 'bold'))
    log_out_image = ImageTk.PhotoImage(Image.open("C:\\Users\\Admin\\PycharmProjects\\OOP Project\\PHOTOS\\LOGO\\Log_Out_Logo.png").resize((39, 32)))
    ...
    search_button = my_gui_design.button_design(frame, 699, 277, 106, 36, "#074173", "white", "Search", ('Century Gothic', 13))
    search_button.config(command=searchEmployee)
    gross_income_button = my_gui_design.button_design(frame, 1132, 1001, 150, 36, "#1679AB", "white", "GROSS INCOME", ('Century Gothic', 13))
    gross_income_button.config(command=grossIncome)
    net_income_button = my_gui_design.button_design(frame, 1297, 1001, 130, 36, "#1679AB", "white", "NET INCOME", ('Century Gothic', 13))
    net_income_button.config(command=netIncome)
    save_button = my_gui_design.button_design(frame, 1442, 1001, 106, 36, "#68D2E8", "white", "SAVE", ('Century Gothic', 13))
    save_button.config(command=saveData)
    update_button = my_gui_design.button_design(frame, 1563, 1001, 106, 36, "#68D2E8", "white", "UPDATE", ('Century Gothic', 13))
    update_button.config(command=updateData)
    new_button = my_gui_design.button_design(frame, 1684, 1001, 106, 36, "#074173", "white", "NEW", ('Century Gothic', 13))
