...
from OOP_Class import design_gui_interface, AnimatedGIFLabel  # Importing design_gui_interface and AnimatedGIFLabel classes from OOP_Class module
...
# ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
    ...
    background_image_path = r"C:\Users\Admin\PycharmProjects\OOP Project\PHOTOS\BACKGROUND\Portal2_Background.gif"
...
# ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
    ...
    images['company_logo'] = ImageTk.PhotoImage(Image.open("C:\\Users\\Admin\\PycharmProjects\\OOP Project\\PHOTOS\\LOGO\\UNIS_Logo3.png").resize((108, 50)))
...
# ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
    def populate_user_info(username): # For needed input once logIn
        ...
        if user:
            ...
            employee_name_label = gui.label_design(frame, 51, 217, f"{full_name}", "#1968A4", "white", ("Century Gothic", 14, 'bold'))
