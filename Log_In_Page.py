...
# ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
background_image_path = r"C:\Users\Admin\PycharmProjects\OOP Project\PHOTOS\BACKGROUND\Log_In_Background.gif"
...
company_logo = gui.image1_design(window, 255, 251, "C:\\Users\\Admin\\PycharmProjects\\OOP Project\\PHOTOS\\LOGO\\UNIS_Logo2.png", 199, 92)
...
eye_open_photo = Image.open("C:\\Users\\Admin\\PycharmProjects\\OOP Project\\PHOTOS\\LOGO\\Show_Password_Logo.png")
eye_open_image = ImageTk.PhotoImage(eye_open_photo.resize((29, 19)))
eye_closed_photo = Image.open("C:\\Users\\Admin\\PycharmProjects\\OOP Project\\PHOTOS\\LOGO\\Don't_Show_Password_Logo.png")
...
def logIn(): # For LogIn Button
    ...
    cursor.execute("SELECT * FROM main_employee_information_tbl WHERE Username=? AND Password=?", (username, password))
