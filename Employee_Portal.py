...
# ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
    ...
    background_image = Image.open("C:\\Users\\Admin\\PycharmProjects\\OOP Project\\PHOTOS\\BACKGROUND\\Registration_Background.png")
...
# ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
    ...
    employee_image = gui.image1_design(picture_frame, 16, 16, "C:\\Users\\Admin\\PycharmProjects\\OOP Project\\PHOTOS\\Profile_Picture.png", 416, 416)
    ...
    company_logo_image = Image.open("C:\\Users\\Admin\\PycharmProjects\\OOP Project\\PHOTOS\\LOGO\\UNIS_Logo.png")
    ...
    company_logo_image2 = Image.open("C:\\Users\\Admin\\PycharmProjects\\OOP Project\\PHOTOS\\LOGO\\UNIS_Logo.png")
    ...
    images = {}
    images['founder_image1'] = ImageTk.PhotoImage(Image.open("C:\\Users\\Admin\\PycharmProjects\\OOP Project\\PHOTOS\\CRUZ_Meagan_Ysabelle.jpg").resize((246, 246)))
    images['founder_image2'] = ImageTk.PhotoImage(Image.open("C:\\Users\\Admin\\PycharmProjects\\OOP Project\\PHOTOS\\LEONIDA_Love_Joy.jpg").resize((246, 246)))
    images['founder_image3'] = ImageTk.PhotoImage(Image.open("C:\\Users\\Admin\\PycharmProjects\\OOP Project\\PHOTOS\\PORCARE_Dana.jpg").resize((246, 246)))
    images['founder_image4'] = ImageTk.PhotoImage(Image.open("C:\\Users\\Admin\\PycharmProjects\\OOP Project\\PHOTOS\\RABINO_Kimberly_Ann.png").resize((246, 246)))
...
# ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
    ...
    profile_image = ImageTk.PhotoImage(Image.open("C:\\Users\\Admin\\PycharmProjects\\OOP Project\\PHOTOS\\LOGO\\Profile_Logo.png").resize((56, 61)))
    ...
    payroll_image = ImageTk.PhotoImage(Image.open("C:\\Users\\Admin\\PycharmProjects\\OOP Project\\PHOTOS\\LOGO\\Payroll_Logo.png").resize((56, 61)))
    ...
    account_image = ImageTk.PhotoImage(Image.open("C:\\Users\\Admin\\PycharmProjects\\OOP Project\\PHOTOS\\LOGO\\Account_Logo.png").resize((56, 61)))
