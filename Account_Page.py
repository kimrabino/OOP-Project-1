...
# ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
    ...
    images['company_logo'] = ImageTk.PhotoImage(Image.open("C:\\Users\\Admin\\PycharmProjects\\OOP Project\\PHOTOS\\LOGO\\UNIS_Logo4.png").resize((515, 237)))
...
# ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
    def updateData():  # For Update Button
        ...
        if record:
            ...
            query4 = """UPDATE employee_user_account_information_tbl SET Username=?, Password=?, Confirm_Password=?, User_Type=?, User_Status=? WHERE Employee_Number=?"""
